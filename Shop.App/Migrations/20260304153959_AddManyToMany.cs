        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("MinNameLength", "LEN(Name) >= 1");
                    table.CheckConstraint("MinSurNameLength", "LEN(SurName) >= 1");
                    table.CheckConstraint("RoleCheck", "[Role] BETWEEN 0 AND 3");
                });
